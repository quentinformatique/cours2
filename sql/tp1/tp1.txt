...
CREATE TABLE `factures_entetes` (
  `ID_ENT_FCT` int(11) PRIMARY KEY NOT NULL,
  `NO_FCT` int(11) NOT NULL,
  `CLIENT` int(11) NOT NULL,
  `DATE_FCT` date NOT NULL,
   CONSTRAINT `fk_ClientFCT` FOREIGN KEY (`CLIENT`) REFERENCES `clients` (`ID_CLIENT`);
) 
...
CREATE TABLE `factures_lignes` (
  `ID_LIG_FCT` int(11) PRIMARY KEY NOT NULL,
  ...
  CONSTRAINT `fk_articleLigF` FOREIGN KEY (`ARTICLE`) REFERENCES `articles` (`ID_ARTICLE`),
  CONSTRAINT `fk_couleurLigF` FOREIGN KEY (`COULEUR`) REFERENCES `a_couleurs` (`CODE_COULEUR`),
  CONSTRAINT `fk_idFCT` FOREIGN KEY (`ID_FCT`) REFERENCES `factures_entetes` (`ID_ENT_FCT`),
  CONSTRAINT `fk_tailleLigF` FOREIGN KEY (`TAILLE`) REFERENCES `a_tailles` (`CODE_TAILLE`);
) 
