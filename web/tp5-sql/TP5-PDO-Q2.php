...
$formSend = isset($_POST['codeClient'])  && isset($_POST['nomMagasin']) && isset($_POST['responsable']) && isset($_POST['adresse1']) && isset($_POST['adresse2']) && isset($_POST['cdp']) && isset($_POST['ville']) &&  isset($_POST['categorie']) && isset($_POST['noTel']) && isset($_POST['mail']);
$formValid = $formSend && $_POST['categorie'] != "none";
...
if ($formValid) {
    ...
    $stmt = $pdo->prepare('INSERT INTO clients (CODE_CLIENT, NOM_MAGASIN, ADRESSE_1, ADRESSE_2, CODE_POSTAL, VILLE, RESPONSABLE, TELEPHONE, EMAIL, TYPE_CLIENT) VALUES (:codeClient, :nomMagasin, :adresse1, :adresse2, :cdp, :ville, :responsable, :noTel, :mail, :categorie)');

    // on execute la requete
    $stmt->execute(['codeClient' => $codeClient, 'nomMagasin' => $nomMagasin, 'responsable' => $responsable, 'adresse1' => $adresse1, 'adresse2' => $adresse2, 'cdp' => $cdp, 'ville' => $ville, 'categorie' => $categorie, 'noTel' => $noTel, 'mail' => $mail, 'categorie' => $categorie]);
}
?>
